...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  1 12:44:33 2020
...
class ResNetResidualBlock(ResidualBlock):
    def __init__(self, in_channels, out_channels, expansion=1, downsampling=1,
        ...
        self.expansion, self.downsampling, self.conv = \
            expansion, downsampling, conv
        # In ResNet, each block has an expansion parameter in order to increase
        # the out_channels if needed. Also, the identity is defined as a
        # Convolution followed by a BatchNorm layer, this is referred to as
        # shortcut.
...
class ResNetBottleNeckBlock(ResNetResidualBlock):
    def __init__(self, in_channels, out_channels, *args, **kwargs):
        super().__init__(in_channels, out_channels, expansion=4,
                         *args, **kwargs)
...
class ResNetLayer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, block=ResNetBasicBlock, n=1,
        ...
        # 'We perform downsampling directly by convolutional layers that
        # have a stride of 2.'
        ...
        self.blocks = nn.Sequential(
            ...
            *[block(out_channels * block.expansion,
                    out_channels, downsampling=1, *args, **kwargs) \
                    for _ in range(n - 1)]
        )
    ...
    def __init__(self, in_channels=3, blocks_sizes=[64, 128, 256, 512],
        ...
        self.blocks = nn.ModuleList([
            ...
            *[ResNetLayer(in_channels * block.expansion,
                          ...
                          block=block, *args, **kwargs) \
              for (in_channels, out_channels), n in zip(self.in_out_block_sizes,
                                                        deepths[1:])]
        ])
